...
volatile long duration3;//the number of the pulses of Moter3
byte encoder3ALast; 
...
double set3 = 6;  // fixed setPoint <=9cm/s
...
void EncoderInit3() //Initialize encoder interruption
{
  ...
  attachInterrupt( 0, wheelSpeed3, CHANGE);  //digitalPinToInterrupt(encoder3A)
} //Interrupt18
