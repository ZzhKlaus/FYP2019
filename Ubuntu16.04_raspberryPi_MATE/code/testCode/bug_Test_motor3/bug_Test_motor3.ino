...
int DIR3A = 26;     //M1 Direction Control
int DIR3B = 27;     
int PWM3 = 7;
int encoder3A = 18;
int encoder3B = 28;
...
void loop(){
  ...
  ***/
  ...
  //PIDMovement3 (set3);  //4 cm/s
  
  endTime3 = millis();
  if(endTime3 - beginTime3 >=sampleTime)
  { 
    Speed3=duration3/53735*5.8*pi*1000/(endTime3 - beginTime3);           // /0.01;
    Input3 = Speed3;
    Serial.print(duration3);
    Serial.print("   ");
    Serial.print(Speed3);
    Serial.print("   ");
    Serial.println(endTime3 - beginTime3);
    //Serial.print("   ");
    ...
    /*
    ZC = Speed3;
    Serial.print(duration3, 5);Serial.print("\t");
...
void EncoderInit3() //Initialize encoder interruption
{
  ...
  attachInterrupt(digitalPinToInterrupt(18) , wheelSpeed3, CHANGE);
} //Interrupt18
