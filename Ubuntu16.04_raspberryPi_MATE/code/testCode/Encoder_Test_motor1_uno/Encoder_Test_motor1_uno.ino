...
int DIR1A = 9;     //M1 Direction Control 9
int DIR1B = 10;     //10
int PWM1 = 6;
int encoder1A = 2;
int encoder1B = 8;
...
//PID variables
double Kp1=59.8,Ki1=143.12, Kd1=1.286; //,46 Ki= 10 15, Kd=0.306;  //Adjust the PID to fit the motor  Kp1=29.8,Ki1=93.12, Kd1=1.286;
double Setpoint1,Input1,Output1;
double set1 = 4;  // fixed setPoint
...
void loop(){
  ...
  { 
    ...
    ZA = Speed1;
    Serial.print(duration1, 5);Serial.print("\t");
